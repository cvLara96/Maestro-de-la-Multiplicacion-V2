...
public class MyAdapterFavs extends RecyclerView.Adapter<MyAdapterFavs.ViewHolderDatos> {
    ...
    public MyAdapterFavs(ArrayList<Contacto> listaContactos, Context context,SlideshowFragment slideshowFragment) {
    ...
    public MyAdapterFavs.ViewHolderDatos onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //DE MANERA QUE AQUI GENERAREMOS UN VIEW INFLADO CON ESE LAYOUT:
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_contactos, null, false);

        return new MyAdapterFavs.ViewHolderDatos(view);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolderDatos holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                slideshowFragment.finalizar(nombreContacto);
